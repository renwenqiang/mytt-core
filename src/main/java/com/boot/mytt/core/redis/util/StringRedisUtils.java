...
public class StringRedisUtils {
    ...
    public StringRedisUtils(StringRedisTemplate redisTemplate) {
     ...
     */
    public boolean valueSet(String key, String value, long time) {
        if (time > 0) {
     ...
     */
    public boolean hashPutAll(String key, Map<String, String> map) {
     ...
     * @return true成功 false失败
     */
    public boolean hashPutAll(String key, Map<String, String> map, long time) {
        redisTemplate.opsForHash().putAll(key, map);
        if (time > 0) {
            expire(key, time);
        }
     ...
     * @return true:成功 false:失败
     */
    public boolean listRightPushAll(String key, List<String> value) {
     ...
     * @return true:成功 false:失败
     */
    public boolean listRightPushAll(String key, List<String> value, long time) {
        redisTemplate.opsForList().rightPushAll(key, value);
        if (time > 0) {
            expire(key, time);
        }
